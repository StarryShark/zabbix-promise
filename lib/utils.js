...
class Client extends Zabbix {
   ...
   * @property {integer} options.port - Zabbix server port to receive sender traffic
   * @default 10051 - Default Zabbix server port
   * @property {string} options.server - Zabbix server name or IP address
   * @property {string} options.host - Zabbix host as configured in frontend
   * @property {string} options.key - Zabbix host item key
   * @property {string} options.value - The value to send
   */
